    ...
    <div class="container">
        ...
        <div style="background-color: #93ffbe;">
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="text-align:center;">
                    ...
                    <h3 style="margin-top:10px;">Registration Details</h3>
        ...
        <div class="row" style="background-color:aliceblue; width: 99.9%; margin-left: 0px;">
            ...
            <div class="col-sm-12" id="home1" style="padding:30px;">
                <strong><?= $name ?></strong>
                <hr>
                <p><span style="color:green;">Start Date: <?= $start_date ?>&nbsp&nbsp</span>|&nbsp <span style="color:red;">End Date: <?= $end_date ?></span></p>
