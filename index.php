                ...
                <div class="col-sm-5">
                    <div class="myTab" style="margin: 2%;">
                        <nav class="nav nav-pills nav-fill">
                            <a title="Register" class="nav-link <?= $registration ?>" href="index.php?type=reg"><i class="fas fa-plus-circle"></i> Registration</a>
                            <a title="Schedules" class="nav-link <?= $schedule ?>" href="index.php?type=sche"><i class="fas fa-calendar-alt"></i> Schedules</a>
                            <a title="Notice" class="nav-link <?= $notice ?>" href="index.php?type=notice"><i class="fas fa-bullhorn"></i> Notices</a>
                            <a title="Contests" class="nav-link <?= $contests ?>" href="index.php?type=contest"><i class="fas fa-laptop-code"></i> Contests</a>
                        </nav>
                    </div>
                </div>
                <!--Home Nevigation End-->
